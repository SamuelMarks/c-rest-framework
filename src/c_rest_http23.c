...
c_rest_error_t
c_rest_http23_ctx_init(c_rest_protocol_t protocol, /* GCOVR_EXCL_LINE */
...
c_rest_error_t
c_rest_http23_ctx_destroy(c_rest_http23_ctx_t *ctx) { /* GCOVR_EXCL_LINE */
...
c_rest_error_t c_rest_http23_process(c_rest_http23_ctx_t *ctx,
...
c_rest_error_t
c_rest_http23_is_request_ready(c_rest_http23_ctx_t *ctx,
...
c_rest_error_t
c_rest_http23_get_request(c_rest_http23_ctx_t *ctx, /* GCOVR_EXCL_LINE */
  ...
  if (!ctx->is_ready) {                          /* GCOVR_EXCL_LINE */
    return C_REST_ERROR_GENERIC; /* Not ready */ /* GCOVR_EXCL_LINE */
  }
...
c_rest_error_t
c_rest_http23_format_response(c_rest_http23_ctx_t *ctx, /* GCOVR_EXCL_LINE */
