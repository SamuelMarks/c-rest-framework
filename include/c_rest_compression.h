...
c_rest_compression_ctx_init(c_rest_compression_ctx_t **ctx,
 ...
 */
C_REST_EXPORT extern c_rest_error_t
c_rest_compression_ctx_destroy(c_rest_compression_ctx_t *ctx);
 ...
 */
C_REST_EXPORT extern c_rest_error_t
c_rest_compress_data(c_rest_compression_ctx_t *ctx,
 ...
 */
C_REST_EXPORT extern c_rest_error_t
c_rest_compress_finish(c_rest_compression_ctx_t *ctx, unsigned char **out_data,
                       size_t *out_len);
 ...
 */
C_REST_EXPORT extern c_rest_error_t
c_rest_compress_buffer(c_rest_compression_type_t type,
                       const unsigned char *in_data, size_t in_len,
                       unsigned char **out_data, size_t *out_len);
