...
int c_rest_orm_crud_get_one(struct c_rest_request *req, /* GCOVR_EXCL_LINE */
                            struct c_rest_response *res, void *user_data) {
...
int c_rest_orm_crud_create(struct c_rest_request *req, /* GCOVR_EXCL_LINE */
                           struct c_rest_response *res, void *user_data) {
  struct c_rest_orm_model *model =
      (struct c_rest_orm_model *)user_data; /* GCOVR_EXCL_LINE */
...
int c_rest_orm_crud_update(struct c_rest_request *req, /* GCOVR_EXCL_LINE */
                           struct c_rest_response *res, void *user_data) {
  struct c_rest_orm_model *model =
      (struct c_rest_orm_model *)user_data; /* GCOVR_EXCL_LINE */
...
int c_rest_orm_crud_delete(struct c_rest_request *req, /* GCOVR_EXCL_LINE */
                           struct c_rest_response *res, void *user_data) {
  struct c_rest_orm_model *model =
      (struct c_rest_orm_model *)user_data; /* GCOVR_EXCL_LINE */
...
int c_rest_orm_health_check(struct c_rest_request *req, /* GCOVR_EXCL_LINE */
                            struct c_rest_response *res, void *user_data) {
  (void)req;
  (void)user_data;
...
int c_rest_orm_run_migrations(struct c_rest_context *ctx, /* GCOVR_EXCL_LINE */
