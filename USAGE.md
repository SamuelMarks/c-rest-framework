...
void setup_user_routes(c_rest_router *router, struct c_rest_context *ctx) {
  /* Enforce transaction wrappers on /api routes */
  ...
  c_rest_router_add(router, "GET", "/api/users", c_rest_orm_crud_get_list, &user_model);
  c_rest_router_add(router, "POST", "/api/users", c_rest_orm_crud_create, &user_model);
  c_rest_router_add(router, "GET", "/api/users/:id", c_rest_orm_crud_get_one, &user_model);
  c_rest_router_add(router, "PUT", "/api/users/:id", c_rest_orm_crud_update, &user_model);
  c_rest_router_add(router, "DELETE", "/api/users/:id", c_rest_orm_crud_delete, &user_model);
}
```
