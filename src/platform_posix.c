...
int c_rest_socket_create(c_rest_socket_t *out_sock) { /* GCOVR_EXCL_LINE */
#if defined(__unix__) || defined(__APPLE__)
  int sock;
...
int c_rest_socket_bind(c_rest_socket_t sock,
...
int c_rest_socket_listen(c_rest_socket_t sock,
...
int c_rest_socket_accept(c_rest_socket_t server_sock, /* GCOVR_EXCL_LINE */
...
int c_rest_socket_set_nonblocking(c_rest_socket_t sock,
...
int c_rest_socket_close(c_rest_socket_t sock) { /* GCOVR_EXCL_LINE */
#if defined(__unix__) || defined(__APPLE__)
  int s = (int)sock;  /* GCOVR_EXCL_LINE */
...
int c_rest_thread_create(c_rest_thread_t *out_thread,
...
int c_rest_thread_join(c_rest_thread_t thread) { /* GCOVR_EXCL_LINE */
#if defined(__unix__) || defined(__APPLE__)
...
int c_rest_cond_create(c_rest_cond_t *out_cond) { /* GCOVR_EXCL_LINE */
#if defined(__unix__) || defined(__APPLE__)
  pthread_cond_t *cond;
...
int c_rest_cond_wait(c_rest_cond_t c, c_rest_mutex_t m) { /* GCOVR_EXCL_LINE */
#if defined(__unix__) || defined(__APPLE__)
...
int c_rest_cond_signal(c_rest_cond_t c) { /* GCOVR_EXCL_LINE */
#if defined(__unix__) || defined(__APPLE__)
  pthread_cond_t *cond = (pthread_cond_t *)c; /* GCOVR_EXCL_LINE */
...
int c_rest_cond_destroy(c_rest_cond_t c) { /* GCOVR_EXCL_LINE */
#if defined(__unix__) || defined(__APPLE__)
  pthread_cond_t *cond = (pthread_cond_t *)c; /* GCOVR_EXCL_LINE */
...
int c_rest_process_create(c_rest_process_t *out_proc,
...
int c_rest_process_wait(c_rest_process_t proc,
...
int c_rest_timer_get_ms(unsigned long *out_ms) { /* GCOVR_EXCL_LINE */
#if defined(__unix__) || defined(__APPLE__)
  struct timespec ts;
...
int c_rest_random_get(void *buffer, size_t size) { /* GCOVR_EXCL_LINE */
...
int c_rest_get_last_error(int *out_error) { /* GCOVR_EXCL_LINE */
...
int c_rest_socket_recv(c_rest_socket_t sock, void *buf,
...
int c_rest_socket_send(c_rest_socket_t sock, const void *buf,
                       size_t len, /* GCOVR_EXCL_LINE */
                       size_t *out_written) {
  ssize_t ret;
